...
if (typeof jQuery === 'undefined') {
  ...
  c.VERSION = '3.3.7', c.TRANSITION_DURATION = 600, c.DEFAULTS = {
    ...
    if (this.$element.trigger(k), !k.isDefaultPrevented()) {
      if (this.sliding = !0, g && this.pause(), this.$indicators.length) {
        this.$indicators.find('.active').removeClass('active'); let l = a(this.$indicators.children()[this.getItemIndex(f)]); 
  ...
  d.VERSION = '3.3.7', d.TRANSITION_DURATION = 350, d.DEFAULTS = {toggle: !0}, d.prototype.dimension = function () {
    ...
    if (!this.transitioning && !this.$element.hasClass('in')) {
      ...
      if (!(e && e.length && (b = e.data('bs.collapse'), b && b.transitioning))) {
        ...
        if (this.$element.trigger(f), !f.isDefaultPrevented()) {
          e && e.length && (c.call(e, 'hide'), b || e.data('bs.collapse', null)); let g = this.dimension();

          this.$element.removeClass('collapse').addClass('collapsing')[g](0).attr('aria-expanded', !0), this.$trigger.removeClass('collapsed').attr('aria-expanded', !0), this.transitioning = 1; let h = function () {
    ...
    if (!this.transitioning && this.$element.hasClass('in')) {
      ...
      if (this.$element.trigger(b), !b.isDefaultPrevented()) {
        ...
        this.$element[c](this.$element[c]())[0].offsetHeight, this.$element.addClass('collapsing').removeClass('collapse in').attr('aria-expanded', !1), this.$trigger.addClass('collapsed').attr('aria-expanded', !1), this.transitioning = 1; let e = function () {
  ...
  a.fn.collapse = c, a.fn.collapse.Constructor = d, a.fn.collapse.noConflict = function () {
    ...
    e.attr('data-target') || d.preventDefault(); let f = b(e), 
  ...
  function b (b) {
    ...
    c || (c = b.attr('href'), c = c && (/#[A-Za-z]/).test(c) && c.replace(/.*(?=#[^\s]*$)/, '')); let d = c && a(c);
  ...
  g.VERSION = '3.3.7', g.prototype.toggle = function (d) {
    ...
    if (!e.is('.disabled, :disabled')) {
      ...
      if (c(), !g) {
        'ontouchstart' in document.documentElement && !f.closest('.navbar-nav').length && a(document.createElement('div')).addClass('dropdown-backdrop').insertAfter(a(this)).on('click', c); let h = {relatedTarget: this};
  ...
  c.VERSION = '3.3.7', c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION = 150, c.DEFAULTS = {
    ...
    this.$element.trigger(e), this.isShown || e.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass('modal-open'), this.escape(), this.resize(), this.$element.on('click.dismiss.bs.modal', '[data-dismiss="modal"]', a.proxy(this.hide, this)), this.$dialog.on('mousedown.dismiss.bs.modal', () => {
      d.$element.one('mouseup.dismiss.bs.modal', b => {
        ...
        d.$element.parent().length || d.$element.appendTo(d.$body), d.$element.show().scrollTop(0), d.adjustDialog(), e && d.$element[0].offsetWidth, d.$element.addClass('in'), d.enforceFocus(); let f = a.Event('shown.bs.modal', {relatedTarget: b});
    ...
    let a = this.$element[0].scrollHeight > document.documentElement.clientHeight; 
    ...
    a.className = 'modal-scrollbar-measure', this.$body.append(a); let b = a.offsetWidth - a.clientWidth; 
  ...
  c.VERSION = '3.3.7', c.TRANSITION_DURATION = 150, c.DEFAULTS = {
    ...
    if (this.hasContent() && this.enabled) {
      this.$element.trigger(b); let d = a.contains(this.$element[0].ownerDocument.documentElement, this.$element[0]);
      ...
      this.setContent(), f.attr('id', g), this.$element.attr('aria-describedby', g), this.options.animation && f.addClass('fade'); let h = typeof this.options.placement === 'function' ? this.options.placement.call(this, f[0], this.$element[0]) : this.options.placement, 
        i = /\s?auto?\s?/i,
        j = i.test(h);
      ...
      j && (h = h.replace(i, '') || 'top'), f.detach().css({
        ...
        left: 0,
        display: 'block'
      }).addClass(h).data(`bs.${this.type}`, this), this.options.container ? f.appendTo(this.options.container) : f.insertAfter(this.$element), this.$element.trigger(`inserted.bs.${this.type}`); let k = this.getPosition(), 
        l = f[0].offsetWidth, 
        m = f[0].offsetHeight; 
      ...
      this.applyPlacement(p, h); let q = function () {
        let a = e.hoverState;
    ...
    }, b), 0), d.addClass('in'); let i = d[0].offsetWidth, 
      j = d[0].offsetHeight; 

    c == 'top' && j != f && (b.top = b.top + f - j); let k = this.getViewportAdjustedDelta(c, b, i, j);

    k.left ? b.left += k.left : b.top += k.top; let l = (/top|bottom/).test(c),
  ...
  c.VERSION = '3.3.7', c.TRANSITION_DURATION = 150, c.prototype.show = function () {
    ...
    function f () {
      ...
      h = e && a.support.transition && (g.length && g.hasClass('fade') || Boolean(d.find('> .fade').length)); 
  ...
  c.VERSION = '3.3.7', c.RESET = 'affix affix-top affix-bottom', c.DEFAULTS = {
    ...
    if (c != null && this.affixed == 'top') {
      return e < c && 'top'; 
    } if (this.affixed == 'bottom') {
      return c != null ? !(e + this.unpin <= f.top) && 'bottom' : !(e + g <= a - d) && 'bottom'; 
    ...
    } this.$element.removeClass(c.RESET).addClass('affix'); let a = this.$target.scrollTop(),
    ...
    if (this.$element.is(':visible')) {
      ...
      typeof d !== 'object' && (f = e = d), typeof e === 'function' && (e = d.top(this.$element)), typeof f === 'function' && (f = d.bottom(this.$element)); let h = this.getState(g, b, e, f);
